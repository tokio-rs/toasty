...
impl<'a> CreateUser<'a> {
    ...
    pub fn package(mut self, package: impl IntoExpr<'a, super::package::Package>) -> Self {
        self.stmt.push_expr(3, package.into_expr());
        self
    }
...
impl<'a> UpdateQuery<'a> {
    ...
    pub fn add_package(
        &mut self,
        package: impl IntoExpr<'a, super::package::Package>,
    ) -> &mut Self {
        self.stmt.push_expr(3, package.into_expr());
        self
    }
...
pub mod fields {
    ...
    impl<'stmt> stmt::IntoExpr<'stmt, super::relation::packages::Packages<'stmt>> for Packages {
        fn into_expr(self) -> stmt::Expr<'stmt, super::relation::packages::Packages<'stmt>> {
...
pub mod relation {
    ...
    pub mod packages {
        ...
        impl<'a> Packages<'a> {
            ...
            pub fn create(self) -> super::super::super::package::CreatePackage<'a> {
            ...
            ) -> super::super::super::package::Query<'a> {
            ...
            pub fn add(
                self,
                packages: impl IntoSelect<'a, Model = super::super::super::package::Package>,
            ) -> Add<'a> {
                Add {
            ...
            pub fn find_by_id(
                self,
                id: impl stmt::IntoExpr<'a, Id<super::super::super::package::Package>>,
            ) -> FindByUserAndId<'a> {
                FindByUserAndId {
        ...
        impl<'a> stmt::IntoSelect<'a> for Packages<'a> {
            type Model = super::super::super::package::Package;
            fn into_select(self) -> stmt::Select<'a, super::super::super::package::Package> {
        ...
        pub struct FindByUserAndId<'a> {
            stmt: stmt::Select<'a, super::super::super::package::Package>,
        }
...
pub mod queries {
    ...
    impl<'a> FindById<'a> {
        ...
        pub fn packages(mut self) -> self::relation::packages::Query<'a> {
