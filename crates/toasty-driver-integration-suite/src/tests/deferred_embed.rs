...
#[driver_test(id(ID, uuid), scenario(crate::scenarios::document_deferred_metadata))]
...
#[driver_test(
    id(ID, uuid),
    scenario(crate::scenarios::document_metadata_deferred_notes)
)]
...
#[driver_test(
    id(ID, uuid),
    scenario(crate::scenarios::document_optional_body_deferred)
)]
