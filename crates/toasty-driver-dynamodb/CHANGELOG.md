...
## [0.11.0](https://github.com/tokio-rs/toasty/compare/toasty-driver-dynamodb-v0.10.0...toasty-driver-dynamodb-v0.11.0) - 2026-08-21

### Added

- Add conditional execution support ([#1182])

### Fixed

- [**breaking**] Stop inferring batch insert IDs ([#1194])
