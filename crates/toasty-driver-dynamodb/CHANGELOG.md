...
## [0.11.0](https://github.com/tokio-rs/toasty/compare/toasty-driver-dynamodb-v0.10.0...toasty-driver-dynamodb-v0.11.0) - 2026-09-14

### Added

- Support conditional logic in queries ([#1182])

### Fixed

- [**breaking**] MySQL batch inserts no longer automatically infer IDs ([#1194])
