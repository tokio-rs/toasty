...
## [0.10.0](https://github.com/tokio-rs/toasty/compare/toasty-driver-dynamodb-v0.9.0...toasty-driver-dynamodb-v0.10.0) - 2026-08-08

### Fixed

- Authority-form SQLite and Turso URLs are now properly resolved ([#1127])
