...
## [0.11.0](https://github.com/tokio-rs/toasty/compare/toasty-sql-v0.10.0...toasty-sql-v0.11.0) - 2026-09-14

### Fixed

- PostgreSQL enum type names are now correctly quoted in SQL ([#1186])
