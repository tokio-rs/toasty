...
## [0.10.0](https://github.com/tokio-rs/toasty/compare/toasty-sql-v0.9.0...toasty-sql-v0.10.0) - 2026-08-08

### Changed

- [**breaking**] `Capability::sql` includes the SQL dialect name ([#1155])
