...
impl Type {
    ...
    pub fn is_equivalent(&self, other: &Type) -> bool {
        ...
        match (self, other) {
            ...
            // Temporal types
            #[cfg(feature = "jiff")]
            (Type::JiffTimestamp, Type::JiffTimestamp) => true,
            #[cfg(feature = "jiff")]
            (Type::JiffZoned, Type::JiffZoned) => true,
            #[cfg(feature = "jiff")]
            (Type::JiffDate, Type::JiffDate) => true,
            #[cfg(feature = "jiff")]
            (Type::JiffTime, Type::JiffTime) => true,
            #[cfg(feature = "jiff")]
            (Type::JiffDateTime, Type::JiffDateTime) => true,

            #[cfg(feature = "chrono")]
            (Type::ChronoDateTimeUtc, Type::ChronoDateTimeUtc) => true,
            #[cfg(feature = "chrono")]
            (Type::ChronoNaiveDateTime, Type::ChronoNaiveDateTime) => true,
            #[cfg(feature = "chrono")]
            (Type::ChronoNaiveDate, Type::ChronoNaiveDate) => true,
            #[cfg(feature = "chrono")]
            (Type::ChronoNaiveTime, Type::ChronoNaiveTime) => true,
