...
## [0.11.0](https://github.com/tokio-rs/toasty/compare/toasty-macros-v0.10.0...toasty-macros-v0.11.0) - 2026-08-21
...
- Struct fields can now be named `path` and `from_path` ([#1196])
