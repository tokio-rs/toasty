...
## [0.11.0](https://github.com/tokio-rs/toasty/compare/toasty-macros-v0.10.0...toasty-macros-v0.11.0) - 2026-09-19
...
- *(macros)* Allow Vec newtypes to derive Embed ([#1197])
- *(macros)* Allow fields named path and from_path ([#1196])
- *(macros)* [**breaking**] Newtype fields are now named `inner` instead of `_0` ([#1183])
