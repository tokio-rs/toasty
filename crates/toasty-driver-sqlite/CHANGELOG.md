...
## [0.11.0](https://github.com/tokio-rs/toasty/compare/toasty-driver-sqlite-v0.10.0...toasty-driver-sqlite-v0.11.0) - 2026-09-14

### Fixed

- [**breaking**] *(mysql)* Batch insert operations no longer automatically infer IDs ([#1194])
