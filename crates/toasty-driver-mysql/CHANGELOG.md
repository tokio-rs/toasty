...
## [0.11.0](https://github.com/tokio-rs/toasty/compare/toasty-driver-mysql-v0.10.0...toasty-driver-mysql-v0.11.0) - 2026-09-19

### Fixed

- [**breaking**] MySQL driver no longer infers batch insert IDs ([#1194])
