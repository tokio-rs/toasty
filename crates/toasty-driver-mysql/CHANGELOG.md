...
## [0.11.0](https://github.com/tokio-rs/toasty/compare/toasty-driver-mysql-v0.10.0...toasty-driver-mysql-v0.11.0) - 2026-09-24

### Added

- Add explicit support for MariaDB ([#1227])
