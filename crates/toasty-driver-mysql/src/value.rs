...
impl Value {
    ...
    pub fn from_sql(i: usize, row: &mut Row, column: &Column, ty: &stmt::Type) -> Self {
        ...
        let core_value = match column.column_type() {
            ...
            CT::MYSQL_TYPE_TIMESTAMP | CT::MYSQL_TYPE_DATETIME => match ty {
                #[cfg(feature = "jiff")]
                stmt::Type::JiffDateTime => {
                    jiff_datetime_or_null(row, i, stmt::Value::JiffDateTime)
                }
                #[cfg(feature = "jiff")]
                ...
                stmt::Type::ChronoDateTimeUtc => {
                    extract_or_null(row, i, |v: chrono::NaiveDateTime| {
            ...
            CT::MYSQL_TYPE_DATE => match ty {
                ...
                #[cfg(feature = "chrono")]
                stmt::Type::ChronoNaiveDate => {
                    extract_or_null(row, i, stmt::Value::ChronoNaiveDate)
                }
