...
## [0.11.0](https://github.com/tokio-rs/toasty/compare/toasty-driver-postgresql-v0.10.0...toasty-driver-postgresql-v0.11.0) - 2026-08-21

### Fixed

- *(mysql)* [**breaking**] Batch insert IDs are no longer inferred automatically ([#1194])
