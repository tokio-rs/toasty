...
## [0.11.0](https://github.com/tokio-rs/toasty/compare/toasty-driver-postgresql-v0.10.0...toasty-driver-postgresql-v0.11.0) - 2026-09-24

### Fixed

- *(mysql)* [**breaking**] Batch inserts no longer automatically infer IDs ([#1194])
