...
## [0.10.0](https://github.com/tokio-rs/toasty/compare/toasty-driver-postgresql-v0.9.0...toasty-driver-postgresql-v0.10.0) - 2026-08-08

### Added

- *(postgresql)* support the options connection URL parameter ([#1156])
